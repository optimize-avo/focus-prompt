# Focus-Prompt Tools Explanation Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create a comprehensive written document explaining how focus-prompt tools work from start to finish, targeting non-technical stakeholders (Marketer/Brand Manager).

**Architecture:** Single Markdown document with structured sections covering installation, configuration, pipeline steps, MCP integration, and troubleshooting. Written in Bahasa Indonesia with non-technical language and analogies.

**Tech Stack:** Markdown documentation, no code dependencies

## Global Constraints

- Document must be understandable by non-technical stakeholders without assistance
- Each step must include actual CLI commands that can be tried
- Explanations must be detailed enough for 15-30 minute presentation
- Include troubleshooting for common issues
- Consistent formatting throughout document
- Language: Bahasa Indonesia (non-technical)

---

## File Structure

- Create: `docs/focus-prompt-tools-guide.md` — Main documentation file
- Modify: `README.md` — Add link to the new guide (optional)

## Task Decomposition

### Task 1: Create Document Foundation and Opening Section

**Files:**
- Create: `docs/focus-prompt-tools-guide.md`

**Interfaces:**
- Consumes: Design spec from `docs/superpowers/specs/2026-07-13-focus-prompt-tools-explanation-design.md`
- Produces: Document skeleton with opening section

- [ ] **Step 1: Create document header and opening section**
...
- [ ] **Step 2: Review opening section for clarity**

Check:
- [ ] Apakah bahasa sudah non-teknis?
- [ ] Apakah analogi sudah tepat?
- [ ] Apakah setiap langkah ada contoh perintah?
- [ ] Apakah penjelasan "mengapa" sudah ada?

- [ ] **Step 3: Commit opening section**

```bash
git add docs/focus-prompt-tools-guide.md
git commit -m "docs: add opening section and preparation steps"
```

---

### Task 2: Add Project Initialization Section

**Files:**
- Modify: `docs/focus-prompt-tools-guide.md`

**Interfaces:**
- Consumes: Opening section from Task 1
- Produces: Section 2 (Memulai Proyek)

- [ ] **Step 1: Add project initialization section**
...
- [ ] **Step 2: Review section for accuracy**

Check against actual CLI commands in README.md:
- [ ] Apakah perintah `fp init` sudah benar?
- [ ] Apakah semua parameter sudah dijelaskan?
- [ ] Apakah contoh sudah realistis?

- [ ] **Step 3: Commit section**

```bash
git add docs/focus-prompt-tools-guide.md
git commit -m "docs: add project initialization section"
```

---

### Task 3: Add Research and Discovery Sections

**Files:**
- Modify: `docs/focus-prompt-tools-guide.md`

**Interfaces:**
- Consumes: Section 2 from Task 2
- Produces: Sections 3 & 4 (Riset Awal & Penemuan Masalah)

- [ ] **Step 1: Add research section**
...
- [ ] **Step 2: Review sections for completeness**

Check:
- [ ] Apakah penjelasan "apa yang terjadi" sudah jelas?
- [ ] Apakah contoh hasil sudah realistis?
- [ ] Apakah tips sudah membantu?

- [ ] **Step 3: Commit sections**

```bash
git add docs/focus-prompt-tools-guide.md
git commit -m "docs: add research and discovery sections"
```

---

### Task 4: Add Clustering and Prompt Generation Sections

**Files:**
- Modify: `docs/focus-prompt-tools-guide.md`

**Interfaces:**
- Consumes: Sections 3 & 4 from Task 3
- Produces: Sections 5 & 6 (Clustering Fokus & Generate Prompt)

- [ ] **Step 1: Add clustering section**
...
- [ ] **Step 2: Review sections for accuracy**

Check against actual code behavior:
- [ ] Apakah penjelasan "Focus" sudah benar?
- [ ] Apakah contoh prompt sudah realistis?
- [ ] Apakah sanitasi sudah dijelaskan dengan benar?

- [ ] **Step 3: Commit sections**

```bash
git add docs/focus-prompt-tools-guide.md
git commit -m "docs: add clustering and prompt generation sections"
```

---

### Task 5: Add Scoring and Export Sections

**Files:**
- Modify: `docs/focus-prompt-tools-guide.md`

**Interfaces:**
- Consumes: Sections 5 & 6 from Task 4
- Produces: Sections 7 & 8 (Skor Relevansi & Export Hasil)
...
Check:
- [ ] Apakah penjelasan skor sudah jelas?
- [ ] Apakah perbandingan JSON vs CSV sudah tepat?
- [ ] Apakah tips sudah membantu?
...
```bash
git add docs/focus-prompt-tools-guide.md
git commit -m "docs: add scoring and export sections"
```

---

### Task 6: Add MCP Server and Troubleshooting Sections

**Files:**
- Modify: `docs/focus-prompt-tools-guide.md`

**Interfaces:**
- Consumes: Sections 7 & 8 from Task 5
- Produces: Sections 9 & 10 (MCP Server & Troubleshooting)
...
Check against actual MCP configuration:
- [ ] Apakah konfigurasi MCP sudah benar?
- [ ] Apakah daftar tools sudah lengkap?
- [ ] Apakah troubleshooting sudah relevan?

- [ ] **Step 3: Commit sections**

```bash
git add docs/focus-prompt-tools-guide.md
git commit -m "docs: add MCP server and troubleshooting sections"
```
...
**Interfaces:**
- Consumes: All sections from Tasks 1-6
...
- [ ] Semua perintah CLI sudah benar
- [ ] Semua penjelasan sudah non-teknis
...
1. [Apa itu Focus-Prompt?](#apa-ini-focus-prompt)
2. [Mengapa Ini Penting?](#mengapa-ini-penting)
3. [Bagian 1: Persiapan](#bagian-1-persiapan)
4. [Bagian 2: Memulai Proyek](#bagian-2-memulai-proyek)
5. [Bagian 3: Riset Awal](#bagian-3-riset-awal)
6. [Bagian 4: Penemuan Masalah](#bagian-4-penemuan-masalah)
7. [Bagian 5: Clustering Fokus](#bagian-5-clustering-fokus)
8. [Bagian 6: Generate Prompt](#bagian-6-generate-prompt)
9. [Bagian 7: Skor Relevansi](#bagian-7-skor-relevansi)
10. [Bagian 8: Export Hasil](#bagian-8-export-hasil)
11. [Bagian 9: MCP Server](#bagian-9-mcp-server)
12. [Bagian 10: Troubleshooting](#bagian-10-troubleshooting)
```
...
```bash
git add docs/focus-prompt-tools-guide.md
git commit -m "docs: finalize focus-prompt tools guide"
```
...
- [ ] Format konsisten di seluruh dokumen
- [ ] Tidak ada placeholder atau TODO
- [ ] Semua perintah CLI sudah benar dan bisa dicoba
